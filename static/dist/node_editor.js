...
function set_node_editor(graph) {
    node_editor.setValue(graph_to_string(graph));
}
function full_button() {
    var count = parseInt(document.getElementById("nodeInput").value);
    var graph = full(count);
    set_node_editor(graph);
}
function star_button() {
    var count = parseInt(document.getElementById("nodeInput").value);
    var directed = document.getElementById("directedCheckbox").checked;
...
function random_button() {
    var count = parseInt(document.getElementById("nodeInput").value);
    var completeness = parseFloat(document.getElementById("completeInput").value);
    var directed = document.getElementById("directedCheckbox").checked;
